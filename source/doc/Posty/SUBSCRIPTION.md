...
本《订阅条款》适用于您在 图记（以下简称"本应用"）中购买的订阅服务，是《用户协议》的补充协议。如本条款与《用户协议》冲突，以本条款为准。
...
| 产品名称 | 类型 | 价格 | 说明 |
|---------|------|------|------|
| 图记月度会员 | 自动续期订阅 | ¥12/月 | 按月计费，自动续期 |
| 图记年度会员 | 自动续期订阅 | ¥88/年 | 按年计费，自动续期 |
| 图记终身会员 | 一次性购买 | ¥198 | 一次付费，永久使用 |

订阅的具体价格以您购买时 App Store 展示的价格为准，可能因地区、汇率、苹果定价策略而调整。

### 2. 订阅计费与续期

2.1 **自动续期**：月度会员和年度会员为自动续期服务。除非您在当前订阅周期结束前至少 24 小时关闭自动续期，否则订阅将自动续费至下一个周期。

2.2 **续期扣费**：续期费用将在当前订阅期结束前 24 小时内从您的 Apple ID 账户扣除。

2.3 **续期价格**：续期价格通常与您订阅的周期价格一致。如价格发生变化，Apple 会在变更生效前通过邮件或应用内通知告知您。

2.4 **免费试用**：本应用目前不提供免费试用。

### 3. 如何管理订阅

您可以随时在以下位置管理或取消订阅：

**iOS 设置 → 您的 Apple ID 头像 → 订阅 → 选择 图记 → 取消订阅**
...
6.1 订阅绑定您的 Apple ID。同一 Apple ID 在多台设备上登录可共享订阅权益。
...
These Subscription Terms apply to subscription services you purchase within 图记 / Posty (the "App") and supplement the Terms of Use. In case of conflict, these Subscription Terms prevail.
...
|---------|------|-------|---------|
| Posty Monthly | Auto-renewing subscription | ¥12/month | Billed monthly, auto-renews |
| Posty Yearly | Auto-renewing subscription | ¥88/year | Billed yearly, auto-renews |
| Posty Lifetime | One-time purchase | ¥198 | Pay once, use forever |
...
2.1 **Auto-Renewal**: Monthly and Yearly subscriptions automatically renew unless auto-renewal is turned off at least 24 hours before the end of the current period.
...
2.4 **Free Trial**: The App currently does not offer a free trial.

### 3. Managing Your Subscription

You can manage or cancel your subscription any time at:

**iOS Settings → Your Apple ID avatar → Subscriptions → Select 图记 / Posty → Cancel**
...
6.1 Subscriptions are bound to your Apple ID. The same Apple ID across multiple devices shares the subscription.
