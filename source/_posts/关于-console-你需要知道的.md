...
<img width=400 src="/images/blog/console/1.png">

新版 chrome 控制台可以将打印信息分类：

<!-- more -->

<img width=200 src="/images/blog/console/2.png">
...
<img width=400 src="/images/blog/console/3.png">

### 添加 CSS 样式

- %c - 样式

<img width=400 src="/images/blog/console/4.png">
...
<img width=400 src="/images/blog/console/5.png">

### 输出 HTML 元素

按照 HTML ELements 结构输出：

<img width=400 src="/images/blog/console/6.png">
...
<img width=400 src="/images/blog/console/7.png">

### console.group( ) & console.groupEnd( )

接下来是另一个富文本能力，按分组输出：

<img width=400 src="/images/blog/console/8.png">
...
<img width=400 src="/images/blog/console/9.png">

### console.assert( )

`console` 版断言工具，当且仅当第一个参数值为 `false` 时才打印第二个参数作为输出。

<img width=400 src="/images/blog/console/10.png">
...
<img width=400 src="/images/blog/console/11.png">

### console.time( )

打印代码执行时间，性能优化和监控场景比较常见。

<img width=400 src="/images/blog/console/12.png">

### console.memory

打印内存使用情况。

<img width=400 src="/images/blog/console/13.png">
